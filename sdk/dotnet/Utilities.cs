...
namespace Pulumi.AwsQuickStartRedshift
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AwsQuickStartRedshift.version.txt");
    ...
    internal sealed class AwsQuickStartRedshiftResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwsQuickStartRedshiftResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
